...
class MediaPipeVisualizer(gl.GLViewWidget) :
    ...
    def updateLeftHand(self, landmark_list) :
        ...
        self.left_hand_line_list = list(filter(
            lambda x : x ,
            self.left_hand_line_list
        ))
    ...
    def updateRightHand(self, landmark_list) :
        ...
        self.right_hand_line_list = list(filter(
            lambda x : x,
            self.right_hand_line_list
        ))
    ...
    def updatePose(self, landmark_list) :
        ...
        self.pose_line_list = list(filter(
            lambda x : x,
            self.pose_line_list
        ))
